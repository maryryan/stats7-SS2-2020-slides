...
<li> TA: Kyle Conniff </li>
   <ul>
   <li> 5th year Statistics PhD student </li>
   <li> <img src="/Users/maryryan/Desktop/teaching-classes/stats7-SS2-2020/stats7-SS2-2020-slides/lec1/lec1-images/e-mail-symbol.png" width="25"/>: <a href="mailto:krconnif@uci.edu ">krconnif@uci.edu </a> </li>
   <li> OH: </li>
   </ul>
...
<li> TA: Jenifer Rim
   ...
   <li> <img src="/Users/maryryan/Desktop/teaching-classes/stats7-SS2-2020/stats7-SS2-2020-slides/lec1/lec1-images/e-mail-symbol.png" width="25"/>: <a href="mailto:jsrim@uci.edu ">jsrim@uci.edu </a> </li>
   <li> OH: </li>
   </ul>
